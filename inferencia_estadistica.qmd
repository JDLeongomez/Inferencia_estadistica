...
author: "
  <span style='font-size:70%;'><strong>Juan David Leongómez</strong></span>
  <span style='font-size:45%;'>PhD, MSc</span><br>
  <span style='font-size:55%;'>
    <a href='https://jdleongomez.info/es' target='_blank'>🌐 jdleongomez.info</a>
    &nbsp;·&nbsp;
...
::: {.incremental}
- El **valor *p*** es la probabilidad de obtener un resultado *tan extremo o más* que el observado, *asumiendo que H₀ es cierta*

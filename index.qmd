...
::: {.nonincremental}
- **Frecuentista**: Neyman & Pearson (1933); cualquier manual clásico de estadística
- **Verosimilitud**: Royall, R. (1997). *Statistical Evidence: A Likelihood Paradigm*. Chapman & Hall
- **Bayesiana**: McElreath, R. (2020). *Statistical Rethinking* (2ª ed.). CRC Press
- **Comparativa y accesible**: Lakens, D. (2021). [*Improving Your Statistical Inferences*](https://lakens.github.io/statistical_inferences/) [libre y en línea]
:::
